...
class SecondActivity : AppCompatActivity() {
    ...
    val launcher = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) {
        ...
        if (result.resultCode == Activity.RESULT_OK) {
            ...
            val age = data?.getStringExtra(MainActivity.EXTRA_AGE)

            // Menetapkan teks di TextView
            binding.txtAddress.text = "Alamat: $address, Umur: $age Tahun"
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding) {
            txtName.text = "Welcome To, ${name}"
            txtAddress.text = "Data Anda belum dilengkapi."
            ...
            //tombol selesai, keluar activity
