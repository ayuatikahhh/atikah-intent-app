    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding) {
            btnToSecondActivity.setOnClickListener {
                ...
                intentToSecondActivity.putExtra(MainActivity.EXTRA_NAME, "Ayu Atikah")
                intentToSecondActivity.putExtra(MainActivity.EXTRA_ADDRESS, "Jl.Sendowo")
                intentToSecondActivity.putExtra(MainActivity.EXTRA_AGE, "19")
